...
```{r}
lineplot() + ggtitle("Vaccination in Maryland over time")
```
...
#box(
  ...
  [
    #grid(
      ...
      [#text(font: "Gentona", size: 11pt)[Vaccines can help prevent expensive disease outbreaks. A 2018–19 measles outbreak in Washington was estimated to cost US\$47,479 per case for both direct medical and public health response expenses.]]
    )
