...
text_content <- glue(
    "In 2024, the same proportion of kindergarteners received at least 1 dose of measles, mumps, and rubella (MMR) vaccine in {state_title} compared to the previous year. {state_title} has {label_coverage1} coverage than the US median and {label_coverage2} coverage than neighboring states. Coverage in {state_title} {label_target} the HP2030 target of 95%."
)
```
