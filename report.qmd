...
#box(
  ...
  [
    #grid(
      ...
      gutter: 1em,
      [#status-box(top-text: "Allows personal exemptions?", bottom-text: "`r first_box`")],
      [#status-box(top-text: "Allows religious exemptions?", bottom-text: "`r second_box`")],
      [#status-box(top-text: "Non-medical exemptions — state", bottom-text: "`r third_box`")],
      [#status-box(top-text: "Non-medical exemptions — US median", bottom-text: "`r fourth_box`")]
    )
  ]
)
```
...
```{=typst}
#status-box(top-text: "Universal Purchaser?", bottom-text: "`r fourth_box`")
```
