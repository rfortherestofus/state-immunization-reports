...
diff <- round(vals_2024 - vals_2023)
...
is_decreasing_yoy <- mmr_coverage_final |>
  filter(
    ...
    school_year %in% c(year_filter_before, year_filter)
  ) |>
  summarise(
    decrease = estimate_percent[school_year == year_filter] <
      estimate_percent[school_year == year_filter_before]
  ) |>
  pull(decrease)
...
#box(
  ...
  #align(right)[
    #source(color: white, "Source: Shioda, Thompson & Patel, et al., 2021")
  ]
]
